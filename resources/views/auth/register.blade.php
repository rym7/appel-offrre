                ...
                <div class="mt-4">
                    <x-label for="terms">
                        <div class="flex items-center">
                            ...
                            <div class="ms-2">
                                {!! __('Je suis d\'accord avec les :terms_of_service et la :privacy_policy', [
                                        'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">'.__('Conditions générales').'</a>',
